...
Beta V1.3       03/10/2001	The Guage height and progress colorisation have been added.
...
**> Legal issues :
              ...
              Copyright (C) 2001 by Boian Mitov
              <mitov@mitov.com>
              <http://www.mitov.com>
...
private:
  ...
  private:
	TBMSpinEdit *FEdit;
    TColor       FGuageBeginColor;
    TColor       FGuageEndColor;
    double       FIncrement;
  ...
  protected:
    ...
    void __fastcall SetGuageBeginColor ( TColor Value );
    void __fastcall SetGuageEndColor ( TColor Value );
  ...
  public :
    __property TColor GuageBeginColor = {read=FGuageBeginColor,write=SetGuageBeginColor};
    __property TColor GuageEndColor = {read=FGuageEndColor,write=SetGuageEndColor};
...
protected:
  ...
  void __fastcall SetGuageBeginColor( TColor Value );
  TColor __fastcall GetGuageBeginColor();
  void __fastcall SetGuageEndColor( TColor Value );
  TColor __fastcall GetGuageEndColor();

  void __fastcall SetTrackBarWidth ( int Value );
  void __fastcall SetPrecision ( int Value );
  void __fastcall SetGuageHeight ( int Value );
...
__published:
    ...
    __property TColor GuageBeginColor = {read=GetGuageBeginColor,write=SetGuageBeginColor, default=clHighlight};
    __property TColor GuageEndColor = {read=GetGuageEndColor,write=SetGuageEndColor, default=clRed};
    ...
    __property int    GuageHeight = {read=FGuageHeight, write=SetGuageHeight, default=5 };
