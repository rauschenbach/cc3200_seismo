...
int  log_read_reg_file(GNS_PARAM_STRUCT *);
...
void log_create_adc_header(GPS_DATA_t *);
void log_fill_adc_header(char, u8, u8);
void log_change_adc_header(SENSOR_DATE_t *);
...
void log_change_num_irq_to_header(u64);
